    ...
    <Overlay display={isClicked} zIndex={100}>
      <div className={css.wrapper}>
        ...
        <BallBar
          ...
          strategyScrollToItem={strategyScrollToItem}
          guideScrollToItem={guideScrollToItem}
          optionStatus={optionStatus}
        />
        <div className='container'>
          {!optionStatus ? (
            <Strategy setBallStatus={setBallStatus} itemRefs={strategyItemRefs} />
          ) : (
            <Guide setBallStatus={setBallStatus} itemRefs={guideItemRefs} />
          )}
        </div>
      </div>
    </Overlay>
