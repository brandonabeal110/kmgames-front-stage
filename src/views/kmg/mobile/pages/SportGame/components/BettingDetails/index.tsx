...
import {ESportType, EStaticsScoreType, EStaticsType, useOtherScoreIds} from '@core/constants/enum/sport';
  ...
  return (
    <Overlay display={isVisiableDetail} zIndex={10} close={close}>
      <div className={styles.wrapper}>
        ...
        {
          false && matchDetail?.sportId === ESportType.FOOTBALL &&
        ...
        {
          isActive === 0 &&
          <BettingContent matchDetail={matchDetail} allOpen={allOpen} />
        }
        {
          isActive === 1 &&
          (
        ...
        <div className={classnames('collapse-icon', {'closed': !allOpen})} onClick={() => setAllOpen((val) => !val)}></div>
      </div>
    </Overlay>
  );
}
