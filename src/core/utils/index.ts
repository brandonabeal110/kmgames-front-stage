...
import {TMatch, TOrder, SubCtid} from '@core/services/Table';
...
export const filterDownPlay = (match: TMatch, subCtid: SubCtid) => {
  ...
  const _arr = [
    {name: '角球', type: 'jiaoqiu', hasData: _hasJiaoqiuData},
    {name: '波胆', type: 'bodan', hasData: _hasBodanData},
    {name: '罚牌', type: 'fapai', hasData: _hasFapaiData},
  ];
